  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { setSubmitting }) => {
      ...
      mutate(values, {
        onSuccess: () => {
          queryClient
            .invalidateQueries(`visit-${visitId}-soap-${soapId}-edit`)
            .then(() => {
              setSubmitStatus({
                status: "success",
                  ...
                  <>
                    {formik.touched.templates && formik.errors.templates && (
                      <div className="alert bg-light-danger text-danger">
                        Anda wajib memilih minimal satu assesmen
                      </div>
                    )}
...
/**
 * Komponen toolbar tambah Assesmen
 */
        ...
        <div className="row justify-content-between">
          <div className="col-md-9 d-flex flex-wrap align-items-center mb-md-0">
            ...
            <div className="overflow-hidden">
              <h1 className="fs-3 mb-0 me-4 text-truncate">Tambah Assesmen</h1>
            </div>
          </div>
