...
// komponen utama membuat diagnosa 10
export default function Create({ visitId, query }) {
  ...
  const [initialValues, setInitialValues] = useState({
    diagnosa_name: "",
    diagnosa_kode: "",
    diagnosa_type: "Diagnosa Primer",
    diagnosa_case: "Baru",
    diagnosa_status: "Diagnosa Awal",
  })
  ...
  useCheckPermission(loggedUser, "tambah icd 10")
  ...
  const mutation = useMutation(
    async ({ data, id }) => {
      setLoading(true)
      return axios
        .post(`/visit/${id}/icd-ten/store`, data)
        .then((res) => res.data)
    },
    {
      onSuccess: () => {
  ...
  return (
    <>
      ...
      <Modal show="true" animation={false}>
        <Modal.Header>
          <Modal.Title>Tambah Diagnosa 10</Modal.Title>
          <GrayCrossIcon
