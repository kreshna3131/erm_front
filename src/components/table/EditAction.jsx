...
/**
 * Komponen kustom edit action dengan ikon
 * @param {{
 * className: String
 * url: String
 * }}
 */
export default function EditAction({ className, url = "/" }) {
  return (
    <ButtonStyled>
      <Link to={url} className={`btn btn-sm btn-icon ${className}`}>
        <svg
